const fs = require('fs');
const d1 = JSON.parse(fs.readFileSync('/Users/jzhp/Documents/trae_projects/buy_house/output/中玮名门_00001267/中玮名门_20260409.json'));
const d2 = JSON.parse(fs.readFileSync('/Users/jzhp/Documents/trae_projects/buy_house/output/中玮名门_00001267/中玮名门_20260410.json'));
...
console.log('中玮名门 4月9日 -> 4月10日 变化:');
console.log('');
...
completedSigning.forEach(id => {
  ...
  if (h) console.log('  ' + h.buildName + ' ' + h.HouseName + ' ' + h.StringLayer + '层');
});
